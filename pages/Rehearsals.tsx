                ...
                <div className="flex gap-2 overflow-x-auto hide-scrollbar pb-2">
                    {[
                        ...
                        <button 
                            ...
                            className={`px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wide transition-all whitespace-nowrap flex items-center gap-2 ${filterStatus === f.id ? 'bg-slate-900 dark:bg-white text-white dark:text-slate-900 shadow-md' : 'text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
                        >
