        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 border-b border-slate-100 dark:border-white/5 pb-8 relative z-10">
            <div>
               ...
               <h1 className="text-4xl md:text-5xl font-display font-bold text-slate-900 dark:text-white leading-[0.9] tracking-tight">
                  Gestão de <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-sky-500">Justificativas</span>
               </h1>
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-[2.5rem] p-6 md:p-8 shadow-sm border border-slate-100 dark:border-white/5">
                            ...
                            <div className="relative group">
                                ...
                                <textarea 
                                    ...
                                    className={`w-full p-6 rounded-[2rem] bg-slate-50 dark:bg-[#0f172a] border-2 outline-none text-sm font-medium leading-relaxed min-h-[160px] resize-none transition-all ${aiFeedback ? 'border-red-500 ring-4 ring-red-500/10' : 'border-slate-200 dark:border-white/5 focus:border-brand-500 focus:bg-white dark:focus:bg-[#1e293b]'}`}
                        ...
                        return (
                            <div key={j.id} className="relative group">
                                ...
                                <div className="bg-white dark:bg-slate-800 rounded-[2rem] p-6 shadow-sm border border-slate-100 dark:border-white/5 relative overflow-hidden transition-all hover:shadow-lg">
                                    ...
                                    <div className="bg-slate-50 dark:bg-[#0f172a] p-4 rounded-2xl border border-slate-100 dark:border-white/5 mb-4">
        ...
        {activeTab === 'admin' && canAdmin && (
            <div className="space-y-8 animate-fade-in">
                ...
                <div className="flex justify-center mb-8">
                    <div className="bg-slate-100 dark:bg-slate-800 p-1 rounded-2xl flex flex-wrap justify-center gap-1 shadow-inner w-full sm:w-auto">
                        {['ALL', 'PENDING', 'ACCEPTED', 'REJECTED'].map(s => (
                            <button 
                                key={s} 
                                onClick={() => setFilterStatus(s as any)} 
                                className={`px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all ${filterStatus === s ? 'bg-white dark:bg-slate-600 text-slate-900 dark:text-white shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                            >
                    ...
                    {adminFilteredJustifications.map(j => (
                        <div key={j.id} className="bg-white dark:bg-slate-800 rounded-[2.5rem] p-6 shadow-sm border border-slate-100 dark:border-white/5 relative group flex flex-col h-full hover:shadow-xl transition-all">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="bg-slate-50 dark:bg-[#0f172a] p-4 rounded-2xl border border-slate-100 dark:border-white/5 h-24 overflow-y-auto custom-scrollbar">
